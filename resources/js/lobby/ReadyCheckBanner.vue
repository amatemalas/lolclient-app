...
<template>
    <div class="ready-check flex items-center gap-4 border border-arcane/30 bg-arcane/5 px-5 py-4">
        ...
        <button
            data-action="accept"
            class="shrink-0 bg-arcane/20 px-5 py-2 text-[11px] font-bold uppercase tracking-[0.18em] text-arcane-bright transition-colors hover:bg-arcane/30 disabled:cursor-not-allowed disabled:opacity-50"
            :disabled="accepting"
            @click="$emit('accept')"
        >Accept</button>
        <button
            data-action="decline"
            class="shrink-0 border border-line px-5 py-2 text-[11px] font-bold uppercase tracking-[0.18em] text-mist transition-colors hover:text-ember disabled:cursor-not-allowed disabled:opacity-50"
            :disabled="declining"
            @click="$emit('decline')"
        >Decline</button>
    </div>
