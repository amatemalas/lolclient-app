...
<template>
    <div class="friend-row group flex items-center gap-3 rounded-sm border border-transparent px-2 py-2 transition-colors hover:border-line/60 hover:bg-steel-2/60">
        ...
        <button
            ...
            :disabled="inviting"
            class="shrink-0 clip-corner-sm border border-arcane/40 px-2 py-1 text-[9px] font-bold uppercase tracking-[0.14em] text-arcane-bright transition-colors hover:bg-arcane/10 disabled:cursor-not-allowed disabled:opacity-50"
